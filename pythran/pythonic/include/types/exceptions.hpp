...
#if PY_MAJOR_VERSION >= 3
    CLASS_EXCEPTION_DECL(BufferError, Exception);
    CLASS_EXCEPTION_DECL(ArithmeticError, Exception);
    CLASS_EXCEPTION_DECL(AssertionError, Exception);
    CLASS_EXCEPTION_DECL(AttributeError, Exception);
    CLASS_EXCEPTION_DECL(EnvironmentError, Exception);
    CLASS_EXCEPTION_DECL(EOFError, Exception);
    CLASS_EXCEPTION_DECL(ImportError, Exception);
    CLASS_EXCEPTION_DECL(LookupError, Exception);
    CLASS_EXCEPTION_DECL(MemoryError, Exception);
    CLASS_EXCEPTION_DECL(NameError, Exception);
    CLASS_EXCEPTION_DECL(ReferenceError, Exception);
    CLASS_EXCEPTION_DECL(RuntimeError, Exception);
    CLASS_EXCEPTION_DECL(SyntaxError, Exception);
    CLASS_EXCEPTION_DECL(SystemError, Exception);
    CLASS_EXCEPTION_DECL(TypeError, Exception);
    CLASS_EXCEPTION_DECL(ValueError, Exception);
#else
...
#define REGISTER_EXCEPTION_TRANSLATOR_DECL(name)                               \
  void translate_##name(types::name const &e);

namespace pythonic
{
  REGISTER_EXCEPTION_TRANSLATOR_DECL(BaseException);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(SystemExit);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(KeyboardInterrupt);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(GeneratorExit);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(Exception);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(StopIteration);
#if PY_MAJOR_VERSION < 3
  REGISTER_EXCEPTION_TRANSLATOR_DECL(StandardError);
#endif
  REGISTER_EXCEPTION_TRANSLATOR_DECL(Warning);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(BytesWarning);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(UnicodeWarning);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(ImportWarning);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(FutureWarning);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(UserWarning);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(SyntaxWarning);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(RuntimeWarning);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(PendingDeprecationWarning);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(DeprecationWarning);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(BufferError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(ArithmeticError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(AssertionError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(AttributeError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(EOFError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(ImportError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(LookupError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(MemoryError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(NameError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(ReferenceError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(RuntimeError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(SyntaxError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(SystemError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(TypeError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(ValueError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(FloatingPointError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(OverflowError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(ZeroDivisionError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(IndexError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(KeyError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(UnboundLocalError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(NotImplementedError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(IndentationError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(TabError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(UnicodeError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(IOError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(EnvironmentError);
  REGISTER_EXCEPTION_TRANSLATOR_DECL(OSError);

#ifdef __VMS
  REGISTER_EXCEPTION_TRANSLATOR_DECL(VMSError);
#endif

#ifdef MS_WINDOWS
  REGISTER_EXCEPTION_TRANSLATOR_DECL(WindowsError);
#endif
}
